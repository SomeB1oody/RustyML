...
/// ```rust
/// use ndarray::array;
/// use rustyml::metric::{Average, MulticlassConfusionMatrix};
///
...
/// ```rust
/// use ndarray::array;
/// use rustyml::metric::cohen_kappa;
///
...
/// ```rust
/// use ndarray::{array, arr2};
/// use rustyml::metric::top_k_accuracy;
///
...
/// ```rust
/// use ndarray::array;
/// use rustyml::metric::average_precision;
///
...
/// ```rust
/// use ndarray::array;
/// use rustyml::metric::precision_recall_curve;
///
/// let labels = array![true, false, true, false];
/// let scores = array![0.9, 0.6, 0.4, 0.1];
