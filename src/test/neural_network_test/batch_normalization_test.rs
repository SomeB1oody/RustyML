...
fn test_batch_normalization_forward_pass_dimensions() {
    ...
    let mut bn = BatchNormalization::new(vec![4, 8], 0.9, 1e-5);
...
fn test_batch_normalization_inference_mode() {
    ...
    let mut bn = BatchNormalization::new(vec![2, 3], 0.9, 1e-5);
...
fn test_batch_normalization_different_batch_sizes() {
    ...
    for batch_size in batch_sizes {
        let mut bn = BatchNormalization::new(vec![batch_size, features], 0.9, 1e-5);
...
fn test_batch_normalization_parameter_count() {
    ...
    let bn = BatchNormalization::new(vec![4, 10], 0.9, 1e-5);
...
fn test_batch_normalization_layer_type() {
    ...
    let bn = BatchNormalization::new(vec![2, 3], 0.9, 1e-5);
...
fn test_batch_normalization_output_shape() {
    ...
    let bn = BatchNormalization::new(vec![4, 8], 0.9, 1e-5);
...
fn test_batch_normalization_with_sequential_model() {
    ...
    model.add(BatchNormalization::new(vec![2, 8], 0.9, 1e-5));
