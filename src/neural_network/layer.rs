...
/// it explicitly (`use crate::neural_network::layer::no_trainable_parameters_layer_functions;`)
...
pub(in crate::neural_network::layer) use no_trainable_parameters_layer_functions;
