...
fn test_sum_of_square_total() {
    ...
    assert_abs_diff_eq!(
        sum_of_square_total(&same_values),
        0.0,
        epsilon = f64::EPSILON
    );
    ...
    assert_abs_diff_eq!(sum_of_square_total(&single), 0.0, epsilon = f64::EPSILON);
}
...
fn test_sum_of_squared_errors() {
    ...
    assert_abs_diff_eq!(
        sum_of_squared_errors(&perfect_prediction, &actual_values),
        0.0,
        epsilon = f64::EPSILON
    );
}
...
fn test_logistic_loss() {
    ...
    let loss1 = logistic_loss(&predictions1.view(), &labels1.view());
    println!("Loss1: {}", loss1);
    ...
    let loss2 = logistic_loss(&predictions2.view(), &labels2.view());
    println!("Loss2: {}", loss2);
    assert!(loss2 > 9.0);
    ...
    let loss3 = logistic_loss(&predictions3.view(), &labels3.view());
    println!("Loss3: {}", loss3);
...
fn test_standard_deviation() {
    ...
    let result = standard_deviation(&same_values.view());
    ...
    assert_abs_diff_eq!(
        standard_deviation(&values.view()),
        expected,
        epsilon = f64::EPSILON
    );
    ...
    assert_abs_diff_eq!(
        standard_deviation(&negative_values.view()),
        expected,
        epsilon = f64::EPSILON
    );
}
