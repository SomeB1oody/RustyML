...
归一化层在 `tuning::norm::` 下又添了 6 道门：`set_/get_batch_norm`、`set_/get_bn_col_stats`、`set_/get_ln_row`、`set_/get_ln_col_stats`、`set_/get_gn_row` 和 `set_/get_gn_param_grad`。这 6 道都出厂在 262_144。
