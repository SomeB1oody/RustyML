...
The normalization layers add 6 more gates under `tuning::norm::`: `set_/get_batch_norm`, `set_/get_bn_col_stats`, `set_/get_ln_row`, `set_/get_ln_col_stats`, `set_/get_gn_row`, and `set_/get_gn_param_grad`. All 6 ship at 262_144.
