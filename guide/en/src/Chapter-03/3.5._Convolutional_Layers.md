...
## 3.5.7. Errors and How to Avoid Them

The convolution layers and the border layers validate their configuration closely. They return typed errors instead of a panic on bad input. The table below lists the common cases and their error variants.
